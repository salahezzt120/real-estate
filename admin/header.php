					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
                             ...
                             <li class="menu-title"> 
								<span>Property Approve</span>
							</li>
						
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span> Property Approve </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="admin_approve_property.php"> Approve </a></li>
									>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span> Booking Requests </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="booking_request.php"> View Booking Requests </a></li>
