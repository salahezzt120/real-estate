            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                               <!-- Book the House Button with Confirmation -->
                               <button onclick="confirmBooking(<?php echo $row['pid']; ?>)" class="booking-button">Book the House</button>
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            ...
                                            <?php if (isset($_SESSION['uid'])): ?>
                                                // User is logged in, redirect to booking confirmation page
                                                window.location.href = "confirm_booking.php?property_id=" + propertyId;
                                            <?php else: ?>
                                                // User is not logged in, show login prompt
                                                Swal.fire({
                                                    title: "Login Required",
                                                    text: "You must be logged in to book this property.",
                                                    icon: "info",
